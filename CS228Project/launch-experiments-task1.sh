...
PRODUCT_CATALOGUE_PATH_FILE="product_data/product_catalogue-v0.2.csv"
TRAIN_PATH_FILE="train_data/train-v0.2.csv"
...
do
    ...
    LOCALE="${LOCALES[$i]}"
    MODEL_SAVE_PATH="task_1_ranking_model_${LOCALE}"
    python train.py \
        ${TRAIN_PATH_FILE} \
